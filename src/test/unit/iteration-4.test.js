...
describe('DistrictRepository iteration 0', () =>  {
  ...
  test('compareDistrictAverages should return 0 if percent is divided by 0', () => {
    const result = { "BETHUNE R-5": 1, "BIG SANDY 100J": 0, "compared": 0};
    expect(district.compareDistrictAverages('BETHUNE R-5', 'BIG SANDY 100J')).toEqual(result);
  });
